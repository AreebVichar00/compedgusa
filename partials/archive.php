...
if ( is_front_page() && ! is_singular( 'page' ) ) {
    ...
    if ( get_bloginfo( 'description' ) ) {
        ...
        $page_title = esc_html__( 'Recent Posts', 'erica' );
    }
...
<main class="site-main" role="main">
	<?php if ( apply_filters( 'erica/filter/enable_page_title', true ) && ( !empty($page_title)  || !empty( $page_description ) ) ) : ?>
        ...
        <div class="site-content--default">
            ...
            if ( have_posts() ) {
	            ...
	            the_posts_pagination([
		            'prev_text'    => __( '&laquo;', 'erica' ),
		            'next_text'    => __( '&raquo;', 'erica' ),
	            ]);
