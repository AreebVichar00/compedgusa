        ...
        <div class="post_item-content">
            ...
            <div class="entry-meta">
                ...
                if(is_sticky() && !is_paged()){
                    echo sprintf('<span class="sticky-post">%s</span>', esc_html__('Featured', 'erica'));
                }

                erica_entry_meta_item_category_list('<div class="post__terms entry-meta__item">', '</div>');
            ...
            <div class="entry-more">
                <a href="<?php the_permalink(); ?>" class="button button-readmore"><?php echo get_post_type() === 'post' ? esc_html__('Read more', 'erica') : esc_html__('View more', 'erica'); ?></a>
            </div>
        </div>
    </div>
</article>