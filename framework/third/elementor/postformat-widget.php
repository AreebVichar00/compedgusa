...
if(!class_exists('Erica_Elementor_PostFormat_Content_Widget')){

	class Erica_Elementor_PostFormat_Content_Widget extends \Elementor\Widget_Base{
		...
		public function get_title() {
			return esc_html__('LaStudioKit PostFormat Content', 'erica');
		}
		...
		protected function register_controls() {
			...
			$this->start_controls_section(
				'section_content',
				[
					'label' => esc_html__( 'Settings', 'erica' ),
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'options' => [
						...
						'center' => [
							'title' => __( 'Center', 'erica' ),
							'icon' => 'eicon-text-align-center',
						],
						'right' => [
							'title' => __( 'Right', 'erica' ),
							'icon' => 'eicon-text-align-right',
						],
						'justify' => [
							'title' => __( 'Justified', 'erica' ),
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Image/Gallery', 'erica' ),
			...
			$this->add_control(
				'custom_height',
				array(
					'label'        => esc_html__( 'Enable Custom Image Height', 'erica' ),
			...
			$this->add_responsive_control(
				'height',
				array(
					'label' => esc_html__( 'Image Height', 'erica' ),
					'type'  => \Elementor\Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => 100,
			...
			$this->add_control(
				'quote_bg_color',
				array(
					'label' => esc_html__( 'Background Color', 'erica' ),
			...
			$this->add_control(
				'quote_text_color',
				array(
					'label' => esc_html__( 'Text Color', 'erica' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => array(
			...
			$this->add_group_control(
				...
				array(
					...
					'label'    => esc_html__( 'Quote Typography', 'erica' ),
			...
			$this->add_group_control(
				...
				array(
					...
					'label'    => esc_html__( 'Cite Typography', 'erica' ),
			...
			$this->add_group_control(
				...
				array(
					...
					'label'    => esc_html__( 'Link Typography', 'erica' ),
			...
			$this->add_responsive_control(
				'link_padding',
				array(
					'label'       => esc_html__( 'Padding', 'erica' ),
		...
		protected function render() {
			...
			echo erica_get_post_thumbnail_format( $image_size );
		}
